    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center gap-3 rounded-lg border border-gray-800/60 bg-rivian-black/30 px-4 py-3">
                ...
                <span className="text-xs text-gray-500 flex-shrink-0">PBOM</span>
                ...
                {selectedFile ? (
                    ...
                    <label htmlFor="pbom-file-input" className="flex items-center gap-2 py-1 px-3 bg-rivian-soft-black border border-dashed border-gray-600 rounded text-sm text-gray-500 hover:border-gray-500 hover:text-gray-400 cursor-pointer transition-colors flex-1">
